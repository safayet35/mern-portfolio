// InfiniteScroll.jsx=
import safuonsky from "../../public/assets/safuonsky.jpg";
...
export default function InfiniteScroll({
  ...
  return (
    <div
      className="relative items-center justify-center flex w-full overflow-hidden overscroll-none border-t-2 border-b-2 border-t-dotted border-b-dotted border-transparent"
      ref={wrapperRef}
      style={{ maxHeight }}
    >
      {/* Gradient Overlays */}
      <div className="absolute top-0 left-0 w-full h-1/4 bg-gradient-to-b from-mainBackground to-transparent z-10 pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-full h-1/4 bg-gradient-to-t from-mainBackground to-transparent z-10 pointer-events-none"></div>
      ...
      >
        {items.map((item, i) => (
          <div
            className="
            p-4 shadow font-semibold text-center border-2
            border-borderColor  rounded-[15px] select-none box-border relative"
            key={i}
            style={{
          ...
          >
            ...
            text-[12px] font-normal text-textColor"
            >
              {item.para}
            </p>
          </div>
